...
### Added
- `/handover-pr` command — the mirror of `/takeover-pr`: packages your own open PR(s) or current branch work into a structured handover and posts it to a Slack thread for a teammate to pick up. Takeover pulls a teammate's work toward you; handover pushes yours to them. Output is the Slack post, not a local checkout.
...
[Unreleased]: https://github.com/DojoCodingLabs/make-no-mistakes-toolkit/compare/v1.32.0...HEAD
